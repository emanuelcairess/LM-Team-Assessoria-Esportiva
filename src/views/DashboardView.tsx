    ...
    <div className="space-y-6 pb-24">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-start sm:items-center gap-4">
            ...
            <div>
              ...
              <h2 id="hero-athlete-name" className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight mt-0.5">
                {athlete.name}
              </h2>
              <p className="text-xs text-slate-600 dark:text-slate-300 mt-1 flex flex-wrap items-center gap-x-3 gap-y-1">
                <span>Orientação: <strong className="text-slate-900 dark:text-white font-bold">{athlete.coachName.split('(')[0]}</strong></span>
                <span>•</span>
                <span>Idade: <strong className="text-slate-900 dark:text-white font-bold">{athlete.age} anos</strong></span>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 bg-slate-100 dark:bg-white/5 p-3 sm:p-4 rounded-2xl border border-slate-200 dark:border-white/10">
            ...
            <div className="text-center px-2">
              ...
              <p id="hero-athlete-weight" className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        >
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 id="daily-nutrition-title" className="text-base font-bold text-slate-900 dark:text-white">Consumo Calórico & Macros Diários</h3>
          ...
          <div className="p-4 rounded-2xl bg-white/5 border border-white/5 mb-5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="relative w-16 h-16 flex items-center justify-center">
                ...
                <span className="absolute text-xs font-black text-slate-900 dark:text-white">{caloriesProgress}%</span>
              </div>
              <div>
                <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total Consumido Hoje</span>
                <p className="text-2xl font-black text-slate-900 dark:text-white">
                  {consumedCalories} <span className="text-xs font-normal text-slate-500 dark:text-slate-400">/ {nutritionPlan.dailyTargetCalories} kcal</span>
                </p>
                ...
                <div
                  ...
                  className={`w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold transition ${
                    m.isCompleted
                      ...
                      : 'bg-white/10 text-slate-600 dark:text-slate-400'
                  }`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="p-3.5 rounded-2xl bg-blue-950/20 border border-blue-500/20">
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-bold text-blue-700 dark:text-blue-400">Proteínas (2g/kg)</span>
                <span className="font-extrabold text-slate-900 dark:text-white">{consumedProtein} / {nutritionPlan.dailyTargetProteinG}g</span>
              </div>
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-1 text-right">{proteinProgress}% meta diária</p>
            </div>

            {/* Carbs */}
            <div className="p-3.5 rounded-2xl bg-amber-950/20 border border-amber-500/20">
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-bold text-amber-700 dark:text-amber-400">Carboidratos</span>
                <span className="font-extrabold text-slate-900 dark:text-white">{consumedCarbs} / {nutritionPlan.dailyTargetCarbsG}g</span>
              </div>
              <div className="w-full h-2 rounded-full bg-slate-200 dark:bg-white/10 overflow-hidden">
                <div
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-1 text-right">{carbsProgress}% meta diária</p>
            </div>

            {/* Fat */}
            <div className="p-3.5 rounded-2xl bg-rose-950/20 border border-rose-500/20">
              <div className="flex items-center justify-between text-xs mb-1.5">
                <span className="font-bold text-rose-700 dark:text-rose-400">Gorduras Boas</span>
                <span className="font-extrabold text-slate-900 dark:text-white">{consumedFat} / {nutritionPlan.dailyTargetFatG}g</span>
              </div>
              <div className="w-full h-2 rounded-full bg-slate-200 dark:bg-white/10 overflow-hidden">
                <div
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-1 text-right">{fatProgress}% meta diária</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900 dark:text-white">Frequência Semanal</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Musculação & Cardio</p>
                </div>
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-orange-500/20 text-orange-700 dark:text-orange-300 border border-orange-500/30">
                Split A-E
              </span>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-3 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-orange-600/30 flex items-center justify-center text-orange-700 dark:text-orange-400 font-black text-sm">
                    5x
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-slate-900 dark:text-white">Dias de Musculação</h4>
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">Seg a Sex (Foco Hipertrofia)</p>
                  </div>
                </div>
                <span className="text-xs font-black text-orange-600 dark:text-orange-400">100% no alvo</span>
              </div>

              <div className="p-3 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-teal-600/30 flex items-center justify-center text-teal-700 dark:text-teal-400 font-black text-sm">
                    7x
                  </div>
                  <div>
                    <h4 className="text-xs font-bold text-slate-900 dark:text-white">Cardio Diário</h4>
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">Meta fixa: 300 kcal (Zona 2)</p>
                  </div>
                </div>
                <span className="text-xs font-black text-teal-600 dark:text-teal-400">7/7 Dias</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between bg-blue-950/20 p-3 rounded-2xl border border-blue-500/20">
            <div className="flex items-center gap-2.5">
              <Droplets className="w-5 h-5 text-cyan-500 dark:text-cyan-400 animate-pulse" />
              <div>
                <p className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Hidratação do Dia</p>
                <p className="text-sm font-extrabold text-slate-900 dark:text-white">3.2L <span className="text-[10px] text-slate-500 dark:text-slate-400">/ 4.0L Meta</span></p>
              </div>
            </div>
            <button
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-xs font-semibold ${
                        isRest ? 'text-blue-600 dark:text-blue-300' : isCardioOnly ? 'text-teal-600 dark:text-teal-300' : 'text-orange-600 dark:text-orange-400'
                      }`}
                    >
                      {workoutDay}
                    </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2.5">
              <div className="p-2 rounded-xl bg-blue-600/20 text-blue-600 dark:text-blue-400 border border-blue-500/30">
                <Scale className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">Resumo de Medidas-Chave</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">Última avaliação: {new Date(currentAssessment.date).toLocaleDateString('pt-BR')}</p>
              </div>
            </div>
            <button
              onClick={() => {
              ...
              className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 flex items-center gap-1"
            >
          ...
          <div className="grid grid-cols-3 gap-2.5">
            <div className="p-3 rounded-2xl bg-white/5 border border-white/5 text-center">
              <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Tórax</span>
              <p className="text-lg font-black text-slate-900 dark:text-white mt-0.5">{currentAssessment.chestCm} cm</p>
              <span className="text-[9px] text-emerald-700 dark:text-emerald-400 font-bold">+3.5 cm ganho</span>
            </div>

            <div className="p-3 rounded-2xl bg-white/5 border border-white/5 text-center">
              <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Ombros</span>
              <p className="text-lg font-black text-slate-900 dark:text-white mt-0.5">{currentAssessment.shouldersCm} cm</p>
              <span className="text-[9px] text-emerald-700 dark:text-emerald-400 font-bold">+4.5 cm delta</span>
            </div>

            <div className="p-3 rounded-2xl bg-white/5 border border-white/5 text-center">
              <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Braço Dir.</span>
              <p className="text-lg font-black text-slate-900 dark:text-white mt-0.5">{currentAssessment.rightArmCm} cm</p>
              <span className="text-[9px] text-emerald-700 dark:text-emerald-400 font-bold">+1.7 cm ganho</span>
            </div>

            <div className="p-3 rounded-2xl bg-emerald-500/10 dark:bg-emerald-950/20 border border-emerald-500/20 text-center">
              <span className="text-[10px] font-bold text-emerald-800 dark:text-emerald-400 uppercase">Cintura</span>
              <p className="text-lg font-black text-slate-900 dark:text-white mt-0.5">{currentAssessment.waistCm} cm</p>
              <span className="text-[9px] text-emerald-700 dark:text-emerald-400 font-bold">-2.5 cm redução</span>
            </div>

            <div className="p-3 rounded-2xl bg-emerald-500/10 dark:bg-emerald-950/20 border border-emerald-500/20 text-center">
              <span className="text-[10px] font-bold text-emerald-800 dark:text-emerald-400 uppercase">Abdômen</span>
              <p className="text-lg font-black text-slate-900 dark:text-white mt-0.5">{currentAssessment.abdomenCm} cm</p>
              <span className="text-[9px] text-emerald-700 dark:text-emerald-400 font-bold">-2.5 cm redução</span>
            </div>

            <div className="p-3 rounded-2xl bg-white/5 border border-white/5 text-center">
              <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Coxa Dir.</span>
              <p className="text-lg font-black text-slate-900 dark:text-white mt-0.5">{currentAssessment.rightThighCm} cm</p>
              <span className="text-[9px] text-emerald-700 dark:text-emerald-400 font-bold">+2.6 cm ganho</span>
            </div>
          </div>
        </motion.div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900 dark:text-white">Protocolos & Suplementação</h3>
              ...
              <button
                ...
                className="text-xs font-bold text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 flex items-center gap-1"
              >
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-5 h-5 rounded-full flex items-center justify-center ${
                        sup.isTakenToday ? 'bg-purple-500 text-black' : 'border border-slate-400 dark:border-slate-500 text-transparent'
                      }`}
                    >
                      <CheckCircle2 className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-slate-900 dark:text-white truncate max-w-[200px]">{sup.name}</h4>
                      <p className="text-[10px] text-purple-700 dark:text-purple-300 font-medium">{sup.schedule.split('(')[0]}</p>
                    </div>
                  </div>
                  <span className="text-[11px] font-semibold text-slate-600 dark:text-slate-400">{sup.dosage.split('(')[0]}</span>
                </div>
              ))}
            </div>
          </div>
