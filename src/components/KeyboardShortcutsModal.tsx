  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-lg rounded-3xl modal-liquid-glass border border-white/20 p-6 shadow-2xl space-y-5 focus:outline-none"
      >
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 id="keyboard-shortcuts-title" className="text-base font-bold text-white">
                Atalhos de Teclado (Web & Tablet)
              </h3>
          ...
          <button
            ...
            className="p-1.5 rounded-xl text-slate-400 hover:text-white hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-blue-500"
          >
        ...
        <div className="pt-2 border-t border-white/10 flex items-center justify-between text-xs text-slate-400">
          <span className="flex items-center gap-1 text-emerald-400 font-semibold">
            <Sparkles className="w-3.5 h-3.5" aria-hidden="true" /> Dica: Pressione Ctrl+K a qualquer momento
          </span>
          <button
            onClick={() => {
              soundFx.playClick();
            ...
            className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs transition focus-visible:ring-2 focus-visible:ring-blue-400"
          >
            Entendido
          </button>
        </div>
